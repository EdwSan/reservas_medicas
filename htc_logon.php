...
<LINK onloadedmetadata="" href="imagenes/estilo.css" type=text/css rel=stylesheet/>
<META http-equiv="" content="text/html; charset=iso-8859-1">
<META content="MSHTML 6.00.2800.1400" name=GENERATOR>
  ...
  <script language="JavaScript" type="text/JavaScript">
  		function Tamano(campo,longitudmin)
  		{
  			...
  			{
  				alert('Debes escribir un valor n�merico en el dato '+campo.name);
  				return false;

  			}
  			if (campo.value.length<longitudmin) {
  				alert('Debes escribir un n�mero al menos de ' + longitudmin + ' cifras en el dato '+campo.name);
  				return false;
  			}
  			return true;
  		}
  		...
  		function LimitarNum(campo,longitudmin,minimo,maximo)
  		{
  			...
  			{
  				alert('Debes escribir un n�mero entre ' + minimo + ' y ' + maximo + ' en el dato '+campo.name);
  				return false;
  			}
  			return true;
  		}
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
	...
	<form name="rsv_logon" method="POST" action="htc_menu.php" onSubmit="return validar('rsv_logon');">
	                      ...
	                      <table border="0" width=41% >
                            ...
                            <tr valign="top">
                              ...
                              <td width="47%" colspan="1"> <input type="text" size="15" name="codigo" value=""  maxlength="10" onChange="Tamano(this,1)" />
                              </td>
                            </tr>
                            <tr valign="top">
                              <td>Clave:</td>
                              <td colspan="1"> <input type="password" size="10" name="clave_internet" value=""  maxlength="10" onChange="LimitarCad(this,1)"/>
                              </td>
                            </tr>
                            <tr valign="top">
                              <td >Tipo de paciente:</td>
                              <td colspan="1"> <select name="tipo_paciente">
                            ...
                            <tr valign="top" >
                              <td colspan="2"  align="right"> <input type="submit" value="Enviar"  />
