...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
 ...
 <script language="JavaScript" type="text/JavaScript">
		function Tamano(campo,longitudmin)
		{
			if (isNaN(campo.value)||(campo.value.length<longitudmin))
			{
				alert('Debes escribir un número al menos de ' + longitudmin + ' cifras en el dato '+campo.name);
				return false;
		...
		function LimitarCad(campo,longitudmin)
		{
			if ( (campo.value.length<longitudmin) )
			{
				alert('Debes escribir una texto de al menos de ' + longitudmin + ' caracteres en el dato '+campo.name);
				return false;
			}
			return true;
		}
		
		function LimitarNum(campo,longitudmin,minimo,maximo)
		{
			if ( isNaN(campo.value) || (campo.value.length<longitudmin) )
			{
				alert('Debes escribir un número al menos de ' + longitudmin + ' cifras en el dato '+campo.name);
			...
			if ( (campo.value.valueOf()< minimo) || (campo.value.valueOf() > maximo) )
			{
				alert('Debes escribir un número entre ' + minimo + ' y ' + maximo + ' en el dato '+campo.name);
				return false;
			}
			return true;
		}		
	...
	<form name="htc_cambiar_pwd" method="POST" action="htc_reg_cambiar_pwd.php" onsubmit="return validar('htc_cambiar_pwd');" >
	
  <table border="0" width=42%  bgcolor="#CCCCCC" >
    <tr valign="top"> 
      <td>&nbsp;</td>
      <td colspan="1">&nbsp;</td>
    </tr>
    <tr valign="top"> 
      <td width="52%">Clave anterior:</td>
      <td width="48%" colspan="1"> <input type="password" size="9" name="clave_anterior" value=""  maxlength="9" onChange="LimitarCad(this,1)"/> 
      </td>
    </tr>
    <tr valign="top"> 
      <td>Clave nueva:</td>
      <td colspan="1"> <input type="password" size="9" name="clave_nueva" value=""  maxlength="9" onChange="LimitarCad(this,1)"/> 
      </td>
    </tr>
    <tr valign="top"> 
      <td>Repetir clave nueva:</td>
      <td colspan="1"> <input type="password" size="9" name="clave_repetida" value=""  maxlength="9" onChange="LimitarCad(this,1)"/> 
      </td>
    </tr>
    <tr valign="top" >
    ...
    <tr valign="top" > 
      <td colspan="2"  align="right"> 
        ...
        <input name="button" type='button'  onClick='IrA("htc_menu.php")'  value='Regresar' /> 
      </td>
    </tr>
  </table>
	</form>
